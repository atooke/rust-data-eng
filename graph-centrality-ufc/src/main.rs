//centrality score = the total number of link chart relationships in which an entity participates.
//centrality article
...
fn main() {
    ...
    add_edge(&mut graph, &fighter_nodes, 2, 5); // Jose Aldo vs. Nate Diaz
    add_edge(&mut graph, &fighter_nodes, 3, 5); // Jose Aldo vs. Nate Diaz
